...
close all;
robotData = load('C:\Users\Jean\Documents\gitProjetoFinal\ensaiosSalvos\esc_2_mudancas_lentas\roboData.txt');
signalsData = load('C:\Users\Jean\Documents\gitProjetoFinal\ensaiosSalvos\esc_2_mudancas_lentas\signalsStream.txt');;
...
figure
fig4 = plot(t,theta,t,maximizante)
grid on
legend('ang robot', 'ang source')
